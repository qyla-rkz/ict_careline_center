...
<body>
                    ...
                    <form id="password-form">
                        <div class="form-group">
                            ...
                            <div class="pw-field-wrap">
                                <input type="password" id="p_current_password" name="current_password" class="form-control" required
                                    placeholder="Masukkan kata laluan semasa">
                                <button type="button" class="pw-toggle-btn" onclick="togglePw('p_current_password', this)" aria-label="Tunjukkan kata laluan" aria-pressed="false"></button>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Kata Laluan Baru</label>
                            <div class="pw-field-wrap">
                                <input type="password" id="p_new_password" name="new_password" class="form-control" required
                                    placeholder="Masukkan kata laluan baru">
                                <button type="button" class="pw-toggle-btn" onclick="togglePw('p_new_password', this)" aria-label="Tunjukkan kata laluan" aria-pressed="false"></button>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Sahkan Kata Laluan Baru</label>
                            <div class="pw-field-wrap">
                                <input type="password" id="p_confirm_password" name="confirm_password" class="form-control" required
                                    placeholder="Ulang kata laluan baru">
                                <button type="button" class="pw-toggle-btn" onclick="togglePw('p_confirm_password', this)" aria-label="Tunjukkan kata laluan" aria-pressed="false"></button>
                            </div>
                        </div>
                        <div style="margin-top: 2rem;">
    ...
    <style>
        ...
        .pw-field-wrap .form-control { padding-right: 2.6rem; }
        .pw-toggle-btn {
            position: absolute;
            right: 0.9rem;
            top: 50%;
