...
<body class="portal-body">
        ...
        <div class="form-container fade-in" style="padding: 2rem 2.5rem; width: 100%; max-width: 450px; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
            ...
            <form id="loginForm">
                ...
                <div class="form-footer" style="margin-bottom: 1rem; font-size: 0.8rem;">
                    ...
                    <a href="#" onclick="showForgotModal(); return false;" style="color: var(--primary);">Lupa?</a>
                </div>
                ...
                <p style="text-align:center; margin-top:1rem; font-size:0.8rem; color: var(--text-muted);">
                    Belum mempunyai akaun? <a href="register" style="color:var(--primary); font-weight:700; text-decoration:none;">Daftar</a>
                </p>
            </form>
        </div>
    </main>
    ...
    <script>
        ...
        document.getElementById('forgotForm').addEventListener('submit', async (e) => {
            ...
            try {
                const res  = await fetch("api/forgot_password"), { method: 'POST', body: fd });
